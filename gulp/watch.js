...
module.exports = function () {
	$.gulp.task('watch', () => {
		...
		if ($.yargs.ftp) {
			...
			$.gulp.watch(path.path.src.libs, $.gulp.series('libs:build', ftp))
			$.gulp.watch(path.path.src.fonts, $.gulp.series('fonts:build', ftp))
		} else {
			...
			$.gulp.watch(path.path.src.libs, $.gulp.series('libs:build'))
			$.gulp.watch(path.path.src.fonts, $.gulp.series('fonts:build'))
		}
	})
